...
data = pd.read_csv(f'../Dataset/preProcessed/CHALLENGER.csv')
...
win_df = df[['Diff_FirstBLOOD', 'Diff_FirstDRAGON', 'Diff_Firsttower',
    'dragonType', 'WIN_controlWARDPlaced', 'WIN_WARDplaced', 'WIN_invadeKill', 'WIN_invadeDeath', 'WIN_TOWERkill',
    ...
    'WIN_WARDkill']]
lose_df = df[['Diff_FirstBLOOD', 'Diff_FirstDRAGON', 'Diff_Firsttower',
    'dragonType', 'LOSE_controlWARDPlaced', 'LOSE_WARDplaced', 'LOSE_invadeKill', 'LOSE_invadeDeath', 'LOSE_TOWERkill',
...
win_df = win_df.rename(columns={f'{colName}_controlWARDPlaced': 'controlWARDPlaced', f'{colName}_invadeKill': 'invadeKill', f'{colName}_invadeDeath': 'invadeDeath', f'{colName}_TOWERkill': 'TOWERkill',
...
colName = 'LOSE'
lose_df = lose_df.rename(columns={f'{colName}_controlWARDPlaced': 'controlWARDPlaced', f'{colName}_invadeKill': 'invadeKill', f'{colName}_invadeDeath': 'invadeDeath', f'{colName}_TOWERkill': 'TOWERkill',
                                                f'{colName}_GOLD_top': 'GOLD_top',f'{colName}_GOLD_jgl': 'GOLD_jgl',f'{colName}_GOLD_mid': 'GOLD_mid',f'{colName}_GOLD_ad': 'GOLD_ad', f'{colName}_GOLD_sup': 'GOLD_sup',
                                                f'{colName}_Kill_top': 'Kill_top',f'{colName}_Kill_jgl': 'Kill_jgl',f'{colName}_Kill_mid': 'Kill_mid',f'{colName}_Kill_ad': 'Kill_ad', f'{colName}_Kill_sup': 'Kill_sup',
                                                f'{colName}_Death_top': 'Death_top',f'{colName}_Death_jgl': 'Death_jgl',f'{colName}_Death_mid': 'Death_mid',f'{colName}_Death_ad': 'Death_ad',f'{colName}_Death_sup': 'Death_sup',
                                                f'{colName}_Asisst_top': 'Asisst_top',f'{colName}_Asisst_jgl': 'Asisst_jgl',f'{colName}_Asisst_mid': 'Asisst_mid',f'{colName}_Asisst_ad': 'Asisst_ad',f'{colName}_Asisst_sup': 'Asisst_sup',
...
win_df, lose_df = mergeCol(win_df, lose_df, 'GOLD')
